...
class JSONListData(pl.LightningDataModule):
    ...
    def process_multiple_examples(self, examples):

        processed_examples = [self.process_single_example(i) if isinstance(i, dict) else self.process_single_example(json.loads(i)) for i in examples['json_content']]
    ...
    def setup(self, stage: str):
        ...
        ds.set_transform(self.process_multiple_examples)
