...
batch_size = 100
# 30 min
with open('product_attribute_extraction_2023q2tli_041723_validprompt_041823_sample_041823_oaiinfer_041823.json', 'w') as f:
    for chunk in tqdm(pd.read_json('product_attribute_extraction_2023q2tli_041723_validprompt_041823_sample_041823.json', 
            lines=True, chunksize=batch_size), total=int(11328/batch_size)):
